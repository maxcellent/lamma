...
import static io.lamma.LammaJavaImports.simpleHolidayRule;
...
public class Q10174526 {
    ...
    public void test() {
        ...
        List<Date> actual = Dates.from(2015, 12, 23).to(2015, 12, 30).byDays(2).except(weekends()).except(ukHoliday2015).build();
